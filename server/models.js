...
export const CATALOG = [
  ...
  },
  {
    ...
    files: [
      { url: `${HF}/Comfy-Org/Ideogram-4/resolve/main/diffusion_models/ideogram4_int8_convrot.safetensors`,
        dest: M("diffusion_models/ideogram4_int8_convrot.safetensors"), bytes: 9583465712 },
      { url: `${HF}/Comfy-Org/Ideogram-4/resolve/main/diffusion_models/ideogram4_unconditional_int8_convrot.safetensors`,
        dest: M("diffusion_models/ideogram4_unconditional_int8_convrot.safetensors"), bytes: 9583465712 },
    ...
    note: "25.8 GB (the VAE is shared with FLUX.2 and is usually already present). int8 convrot build — the family this card runs best. Hunyuan Image 3.0 was evaluated and rejected: 48 GB of weights even at NF4, physically over this machine's memory.",
