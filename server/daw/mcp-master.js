...
import { LOUDNESS_SCHEMA } from "./bounce-options.js";
  ...
  return [
...

    {
      ...
      description:
        ...
        + "Pass target_lufs, ceiling_db and max_limit_db to add a custom preflight row using "
        + "the same loudness plan as daw_bounce. This measurement does not write or master audio.",
      inputSchema: {
        type: "object",
        properties: {
          slug: { type: "string", description: "Project slug (omit only with `file`)." },
