 ...
 * (One one-list helper is the exception, because a copy of a list is the
 * drift this paragraph warns about: ../mv/sizes.js, which is pure and reads
 * only ../h3tier.js, pure too.)
