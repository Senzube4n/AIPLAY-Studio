...
1. METADATA — required, not optional. The MiniMax-Music3 Community Licence's
   acceptable-use policy requires machine-generated content to be disclosed, so
   every export carries it and the app does not offer a switch.
...
def main() -> int:
    ...
    # Vorbis comment keys that players and taggers actually read.
    meta = {
        ...
        "COMMENT": "Generated locally with MiniMax-Music3.",
        # Machine-generated disclosure — the licence's AUP requires this.
        "GENERATED_BY": "MiniMax-Music3",
        "AI_GENERATED": "true",
        ...
        "SIGMA_SCHEDULE": f"shift {raw.get('shift', '')}",
